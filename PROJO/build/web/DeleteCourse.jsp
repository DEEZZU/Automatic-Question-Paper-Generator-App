<%-- 
    Document   : AddCourse
    Created on : 29 Oct, 2017, 4:01:35 AM
...
<body id="bg" background="BG3.jpg" margin="auto" >
    <div class="container">
        ...
        <div class="base">
           <div class="des1">                        
             <div class="des2">   
                <h4 class="font_1"><span>Admin! Kindly enter the details of course you want to delete.</span></h4>                     
                <form action="ProcessDeleteCourse.jsp" >
                   <table  border='0' cellpadding='0' cellspacing='35px' style=" width:700px;overflow:auto;text-align:center;margin:auto;">                                                              
                                                                
                                    <tr><td><input type="text" id="CI" name="c_sid" placeholder="Course ID" Default="Null"></td></tr>                                    
                                    <tr></tr>                             
