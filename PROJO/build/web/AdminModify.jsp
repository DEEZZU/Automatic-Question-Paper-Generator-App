<%-- 
    ...
    Created on : 1 Nov, 2017, 9:46:01 PM
        ...
        <div class="base">
           <div class="des1">                        
             <div class="des2">   
                ...
                <br><h4 class="font_1" style="margin:auto;"><span>What do you want to modify?</span></h4><br>                  
                   <table  border='0' cellpadding='0' cellspacing='35px' style=" width:500px;overflow:auto;text-align:center;margin:auto;">
                                <tr><td><input type="button" value="User" style="color:#000000;"></td></tr>                                
                                <tr><td><input type="button" value="Course" style="color:#000000;"></td></tr> 
